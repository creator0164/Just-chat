...
# gawa ng mas malupit hahaha. Solve ang cache issue. Resource: http://masnun.rocks/2017/03/20/django-admin-expensive-count-all-queries/
...
class PublicRoomChatMessageAdmin(admin.ModelAdmin):
    ...
    list_display = ['room', 'user', 'timestamp', 'timestamp']
